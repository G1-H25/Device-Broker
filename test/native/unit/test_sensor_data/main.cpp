...
void test_buffer_to_json() {
    ...
    TEST_ASSERT_EQUAL(temp_data, arr[0][HTTP_API_JSON_TIME_KEY]);
    TEST_ASSERT_EQUAL(temp_data, arr[0][HTTP_API_JSON_HUM_KEY]);
    TEST_ASSERT_EQUAL(temp_data, arr[0][HTTP_API_JSON_TEMP_KEY]);

    TEST_ASSERT_EQUAL(temp_data, arr[1][HTTP_API_JSON_TIME_KEY]);
    TEST_ASSERT_EQUAL(temp_data, arr[1][HTTP_API_JSON_HUM_KEY]);
    TEST_ASSERT_EQUAL(temp_data, arr[1][HTTP_API_JSON_TEMP_KEY]);
}
